                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ $pesanan->tgl_keluar }}" type="date" placeholder="dd/mm/yyyy" name="tgl_masuk"/>
                                    @error('tgl_masuk')
                                      <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                  <input type="nubmer" class="form-control @error('qty') is-invalid @enderror" name="qty" value="{{ $pesanan->qty }}" />
                                  @error('qty')
                                    <p class="text-danger">{{ $message }}</p>
                                  @enderror
                                </div>
