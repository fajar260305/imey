            ...
            <div class="card-body">
              <form class="form-sample" action="/paket/edit/{{ $paket->id }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" value="{{ $paket->batas_waktu }}" name="batas_waktu" class="form-control phone-number">
                </div>
                <div class="form-group">
                  <label>Harga</label>
                  <input type="text" name="harga" value="{{ $paket->harga }}" class="form-control pwstrength" data-indicator="pwindicator">
                </div>
