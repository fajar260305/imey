            ...
            <div class="row">
              <div class="col-md-6">
                <h5>Tambah Pengguna</h5>
                  <a href="/pengguna/tambah" class="btn btn-outline-light w-25 mb-3" >Tambah</a>
              </div>
            </div>
            <div class="card">
                <div class="card-body">
                            ...
                            <td>
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <form action="/pengguna/delete/{{ $user->id }}" method="post">
                                      @csrf
                                      @method('delete')
                                      {{-- <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button> --}}
                                      <button type="submit" class="dropdown-item">Hapus</button>
                                    </form>
                                    <a class="dropdown-item" href="/pengguna/edit/{{ $user->id }}">Edit</a>
                                  </div>
                                </div>
                            </td>
                          </tr>
